...
- `design/contrast-failure`
- `design/missing-focus-state`
- `design/layout-shift`
- `design/inconsistent-spacing`
- `design/hierarchy-violation`
- `design/unknown` — fall-back when no enum value fits
